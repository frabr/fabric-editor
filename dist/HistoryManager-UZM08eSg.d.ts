import { IText, FabricObject, Group, FabricImage, Canvas, Rect } from 'fabric';
...
export { type ControlOption as C, type EditorConfig as E, type FontsConfig as F, HistoryManager as H, ImageFrame as I, LayerManager as L, type ObjectControlsConfig as O, PersistenceManager as P, type SelectionCallbacks as S, type TextLayerOptions as T, type LayerData as a, type ShapeType as b, PendingUploadsManager as c, applyLockMode as d, getNextLockMode as e, isPositionLocked as f, getLockMode as g, isStyleLocked as h, isContentLocked as i, CustomTextbox as j, type EditorState as k, type FontConfig as l, type LockMode$1 as m, type ImageLayerOptions as n, type ShapeLayerOptions as o, type SaveOptions as p, type SaveResult as q, type HistoryState as r, type HistoryCallbacks as s };
